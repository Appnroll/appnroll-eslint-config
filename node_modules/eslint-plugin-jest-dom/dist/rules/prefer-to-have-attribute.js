...
const create = context => ({
  [`CallExpression[callee.property.name='getAttribute'][parent.callee.name='expect'][parent.parent.property.name=/toBeNull/]`](node) {
    context.report({
      ...
      fix: fixer => [fixer.removeRange([node.callee.object.range[1], node.range[1]]), fixer.replaceTextRange([node.parent.parent.property.range[0], node.parent.parent.parent.range[1]], `not.toHaveAttribute(${node.arguments[0].raw})`)]
    });
  },
  ...
  [`CallExpression[callee.property.name='getAttribute'][parent.callee.name='expect'][parent.parent.property.name=/toContain$|toMatch$/]`](node) {
    context.report({
      node: node.parent,
      message: `Use toHaveAttribute instead of asserting on getAttribute`,
      fix: fixer => [fixer.removeRange([node.callee.object.range[1], node.range[1]]), fixer.replaceText(node.parent.parent.property, "toHaveAttribute"), fixer.replaceText(node.parent.parent.parent.arguments[0], `${node.arguments[0].raw}, expect.string${node.parent.parent.property.name.slice(2)}ing(${node.parent.parent.parent.arguments[0].raw})`)]
    });
  },
  ...
  [`CallExpression[callee.property.name='getAttribute'][parent.callee.name='expect'][parent.parent.property.name=/toBe$|to(Strict)?Equal/]`](node) {
    ...
    context.report({
      ...
      message: `Use toHaveAttribute instead of asserting on getAttribute`,
      fix: fixer => {
        const lastFixer = isNullOrEmpty ? fixer.replaceText(node.parent.parent.parent.arguments[0], node.arguments[0].raw) : fixer.insertTextBefore(node.parent.parent.parent.arguments[0], `${node.arguments[0].raw}, `);
  ...
  [`CallExpression[callee.property.name='hasAttribute'][parent.callee.name='expect'][parent.parent.property.name=/toBe$|to(Striclty)?Equal/]`](node) {
    if (typeof node.parent.parent.parent.arguments[0].value === "boolean") {
      context.report({
        ...
        fix: fixer => [fixer.removeRange([node.callee.object.range[1], node.range[1]]), fixer.replaceText(node.parent.parent.property, `${node.parent.parent.parent.arguments[0].value === false ? "not." : ""}toHaveAttribute`), fixer.replaceText(node.parent.parent.parent.arguments[0], node.arguments[0].raw)]
      });
    } else {
      context.report({
        node: node.parent.parent.property,
  ...
  [`CallExpression[callee.property.name='hasAttribute'][parent.callee.name='expect'][parent.parent.property.name=/toBeTruthy|toBeFalsy/]`](node) {
    context.report({
      node: node.parent,
      message: `Use toHaveAttribute instead of asserting on hasAttribute`,
      fix: fixer => [fixer.removeRange([node.callee.object.range[1], node.range[1]]), fixer.replaceTextRange([node.parent.parent.property.range[0], node.parent.parent.parent.range[1]], `${node.parent.parent.property.name === "toBeFalsy" ? "not." : ""}toHaveAttribute(${node.arguments[0].raw})`)]
    });
  }
